...
function init() {
    ...
    todos = [
      ...
      { id: 5, task: 'Remote to Tech Elevator', completed: false },
      { id: 6, task: 'Make Coffee', completed: false },
      { id: 7, task: 'Job Search Job Search', completed: false },
      { id: 8, task: 'Dinner', completed: false },
      { id: 9, task: 'Existential Dread', completed: false },
